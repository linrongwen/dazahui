...
$config['site_copyright'] = 'Copyright © 2015 上海商创网络科技有限公司, All Rights Reserved'; //版权信息
...
$config['SMTP_PASSWORD'] = '136349117'; //smtp服务器帐号密码，如你的qq邮箱密码
$config['SMTP_FROM_TO'] = 'w136349117@qq.com'; //发件人邮件地址
$config['SMTP_FROM_NAME'] = '系统邮件'; //发件人姓名
$config['SMTP_CHARSET'] = 'utf-8'; //发送的邮件内容编码
//EcTouch版本
$config['ver'] = '2.1'; //版本号
$config['ver_name'] = '商创网络'; //版本名称
