...
<li class="explode" key="menu_2" name="menu">
	会员管理
    <ul>
        <li class="menu-item"><a href="users.php?act=list" target="main-frame"><font style="color:red">会员列表</font></a></li>
...
<li name="menu" key="02_cat_and_goods" class="explode">
   <font style="color:red"> 分销设置</font>        <ul style="display: block;">
		...
		<li class="menu-item"><a href="article_tianxin100.php?act=list" target="main-frame">单品推广设置</a></li>
...
<li class="explode" key="menu_3" name="menu">
    ...
    <ul>
      <li class="menu-item"><a href="wxch-ent.php?act=wxconfig" target="main-frame">微信接口</a></li>
		  ...
		  <li class="menu-item"><a href="wxch-ent.php?act=autoreg" target="main-frame"><font style="color:red">自动注册</font></a></li>
          ...
          <li class="menu-item"><a href="wxch-ent.php?act=tuijian" target="main-frame">扫码引荐</a></li>
		   <li class="menu-item">
		   <a href="users_invite.php?act=list" target="main-frame">推荐人列表</a></li>
        </ul>
</li>
