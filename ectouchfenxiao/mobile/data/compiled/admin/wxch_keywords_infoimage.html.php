...
<table width="100%" id="two-table" align="center" >
           <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="keyword" value="<?php echo $this->_var['data']['keyword']; ?>" style="float:left;color:;" size="20" />
                    <span class="require-field">*</span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="type">
                        <option value="2" <?php if ($this->_var['data']['type'] == 2): ?>selected="selected"<?php endif; ?>>图文</option>
                    </select>
                    <span class="require-field">*</span>
                </td>
            </tr>
