...
<?php echo $this->_var['card']['bind_date']; ?><?php endif; ?></td>
    ...
    <td align="center"><a href="user_card.php?act=edit&id=<?php echo $this->_var['card']['id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>&nbsp;
    <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['card']['id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="16" width="16"></a>
