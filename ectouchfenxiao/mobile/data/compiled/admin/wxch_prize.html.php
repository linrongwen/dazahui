...
?>
            <tr>
                ...
                <a href="/wechat/<?php if ($this->_var['list']['fun'] == 'egg'): ?>egg<?php else: ?>dzp<?php endif; ?>/index.php?pid=<?php echo $this->_var['list']['pid']; ?>" target="_blank" title="查看"><img src="images/icon_view.gif" width="16" height="16" border="0" /></a>
                    <a href="wxch_prize.php?act=edit_prize&pid=<?php echo $this->_var['list']['pid']; ?>" title="编辑规则"><img src="images/icon_priv.gif" border="0" height="16" width="16" /></a>&nbsp;
      <a href="wxch_prize.php?act=edit&pid=<?php echo $this->_var['list']['pid']; ?>" title="编辑奖品、数量"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>&nbsp;
     <!--  --><a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['pid']; ?>, '您确认要删除这个规则吗？')" title="移除"><img src="images/icon_drop.gif" border="0" height="16" width="16"></a><!--  --></span>
                </td>
            </tr>
