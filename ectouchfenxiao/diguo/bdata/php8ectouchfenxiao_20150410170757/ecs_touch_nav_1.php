...
E_D("replace into `ecs_touch_nav` values('4','','0','分销中心','1','0','0','distribute.php','icon_indexn_04.png','middle');");
...
E_D("replace into `ecs_touch_nav` values('32','c','1','彩妆','0','2','0','category.php?id=1','','middle');");
