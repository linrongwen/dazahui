...
E_D("replace into `wxch_cfg` values('2','baseurl','http://znrr.com/ectouchfx/','yes');");
E_D("replace into `wxch_cfg` values('3','imgpath','local','yes');");
E_D("replace into `wxch_cfg` values('4','plustj','true','yes');");
E_D("replace into `wxch_cfg` values('5','userpwd','123456','yes');");
...
E_D("replace into `wxch_cfg` values('12','tianxin_url','','yes');");
