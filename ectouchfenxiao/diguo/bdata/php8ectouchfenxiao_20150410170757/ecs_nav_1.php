...
E_D("replace into `ecs_nav` values('29','a','12','站内快讯','0','7','0','article_cat.php?id=12','middle');");
E_D("replace into `ecs_nav` values('31','a','13','化妆品','0','24','0','article_cat.php?id=13','middle');");
