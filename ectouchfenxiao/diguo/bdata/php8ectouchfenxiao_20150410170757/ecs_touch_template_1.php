...
E_D("replace into `ecs_touch_template` values('index','中部主区域','/library/cat_articles.lbi','4','3','4','3','miqinew','');");
E_D("replace into `ecs_touch_template` values('index','中部主区域','/library/group_buy.lbi','3','0','2','0','miqinew','');");
E_D("replace into `ecs_touch_template` values('index','中部主区域','/library/recommend_promotion.lbi','2','0','4','0','miqinew','');");
E_D("replace into `ecs_touch_template` values('index','中部主区域','/library/recommend_hot.lbi','0','0','4','0','miqinew','');");
...
E_D("replace into `ecs_touch_template` values('index','中部主区域','/library/recommend_new.lbi','1','0','4','0','miqinew','');");
E_D("replace into `ecs_touch_template` values('index','中部主区域','/library/recommend_best.lbi','5','0','4','0','miqinew','');");
