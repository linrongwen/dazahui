...
E_D("replace into `ecs_template` values('index','商品区域五','/library/cat_goods.lbi','0','16','10','1','miqinew','');");
E_D("replace into `ecs_template` values('index','商品区域四','/library/cat_goods.lbi','0','12','10','1','miqinew','');");
E_D("replace into `ecs_template` values('index','商品区域三','/library/cat_goods.lbi','0','17','10','1','miqinew','');");
E_D("replace into `ecs_template` values('index','商品区域二','/library/cat_goods.lbi','0','1','10','1','miqinew','');");
E_D("replace into `ecs_template` values('index','邮件订阅','/library/order_query.lbi','1','0','0','0','miqinew','');");
...
E_D("replace into `ecs_template` values('index','','/library/brands.lbi','0','0','3','0','miqinew','首页');");
E_D("replace into `ecs_template` values('index','','/library/group_buy.lbi','0','0','25','0','miqinew','首页');");
E_D("replace into `ecs_template` values('index','','/library/auction.lbi','0','0','3','0','miqinew','首页');");
E_D("replace into `ecs_template` values('index','','/library/recommend_promotion.lbi','0','0','1','0','miqinew','首页');");
E_D("replace into `ecs_template` values('index','','/library/recommend_hot.lbi','0','0','3','0','miqinew','首页');");
E_D("replace into `ecs_template` values('index','','/library/recommend_new.lbi','0','0','2','0','miqinew','首页');");
E_D("replace into `ecs_template` values('index','','/library/recommend_best.lbi','0','0','2','0','miqinew','首页');");
E_D("replace into `ecs_template` values('index','商品区域一','/library/cat_goods.lbi','0','6','10','1','miqinew','首页');");
E_D("replace into `ecs_template` values('index','商品区域三','/library/cat_goods.lbi','0','17','10','1','miqinew','首页');");
E_D("replace into `ecs_template` values('index','商品区域二','/library/cat_goods.lbi','0','1','10','1','miqinew','首页');");
E_D("replace into `ecs_template` values('index','商品区域五','/library/cat_goods.lbi','0','16','10','1','miqinew','首页');");
E_D("replace into `ecs_template` values('index','商品区域四','/library/cat_goods.lbi','0','12','10','1','miqinew','首页');");
E_D("replace into `ecs_template` values('index','热销排行榜','/library/top10.lbi','0','0','0','0','miqinew','首页');");
E_D("replace into `ecs_template` values('index','邮件订阅','/library/order_query.lbi','1','0','0','0','miqinew','首页');");
E_D("replace into `ecs_template` values('index','邮件订阅','/library/email_list.lbi','0','0','0','0','miqinew','首页');");
