...
<div class="blank"></div>
  ...
  <div class="content_body2 " style="color:#666;">
      ...
      <div class="memInfo">
        ...
        <div class="userInfo">
        <div class="welcome" style=" height:23px;line-height:23px;color:#666;">
        <span class=" weiruan f_l" style="font-size:16px;padding: 0 5px 0 0;"><?php echo $this->_var['info']['username']; ?> </span>
        <div style="margin-left:10px; "></div>&nbsp;<?php echo $this->_var['lang']['welcome_to']; ?> <?php echo $this->_var['info']['shop_name']; ?>！</div>
          <div class="blank"></div>
          <div class="creditInfo"><?php echo $this->_var['lang']['last_time']; ?>: <?php echo $this->_var['info']['last_time']; ?></div>
          <div class="blank5"></div>
          <div class="creditInfo"><?php echo $this->_var['rank_name']; ?> <?php echo $this->_var['next_rank_name']; ?></div>
          <div class="blank5"></div>
           <?php if ($this->_var['info']['is_validate'] == 0): ?>
          <?php echo $this->_var['lang']['not_validated']; ?> <a href="javascript:sendHashMail()"  class="pink "><?php echo $this->_var['lang']['resend_hash_mail']; ?></a><br />
           <?php endif; ?>
             </div>
             <div class="blank"></div>
                <div class="blank"></div>
           <div  class="infoTip" >
           <span class="bold"><img src="themes/miqinew/images/infoTip.jpg" border="0"></span>&nbsp;<?php echo $this->_var['user_notice']; ?>
           </div>
     
          <div class="goodsInfo " >
          <div class="Invitation_txt"><?php echo $this->_var['lang']['your_account']; ?></div>
          <div class="blank"></div>
          <div style="padding-left:5px;">
          <?php echo $this->_var['lang']['your_surplus']; ?>:<a href="user.php?act=account_log" class="pink "><?php echo $this->_var['info']['surplus']; ?></a><br />
          <?php if ($this->_var['info']['credit_line'] > 0): ?>
          <?php echo $this->_var['lang']['credit_line']; ?>:<?php echo $this->_var['info']['formated_credit_line']; ?><br />
          <?php endif; ?>
          <?php echo $this->_var['lang']['your_bonus']; ?>:<a href="user.php?act=bonus" class="pink "><?php echo $this->_var['info']['bonus']; ?></a><br />
          <?php echo $this->_var['lang']['your_integral']; ?>:<?php echo $this->_var['info']['integral']; ?><br />
          </div>
          </div>
          <div  class="goodsInfo " >
          <div class="Invitation_txt"><?php echo $this->_var['lang']['your_notice']; ?></div>
          <div class="blank"></div>
          <div style="padding-left:5px;">
...
?>
    ...
    foreach ($_from AS $this->_var['item']):
?>
          <a href="user.php?act=order_detail&order_id=<?php echo $this->_var['item']['order_id']; ?>" class="pink "><?php echo $this->_var['item']['order_sn']; ?></a>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          <?php endif; ?>
        </div>
          </div>
         ...
         <?php if ($this->_var['action'] == 'message_list'): ?>
          <h5><?php echo $this->_var['lang']['label_message']; ?></h5>
          <div class="blank"></div>
...
?>
          ...
          <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
                  <table width="100%" border="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td>
                      <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/miqinew/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
         ...
         <?php endif; ?>
          ...
          <h5><?php echo $this->_var['lang']['label_comment']; ?></h5>
          <div class="blank"></div>
...
?>
    <a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/miqinew/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp;
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <?php else: ?>
