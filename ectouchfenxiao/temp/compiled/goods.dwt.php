...
?>
                ...
                <p class="catt" >
                <strong style="float:left; width:60px; font-size: 13px;color: #999; font-weight:normal; padding-top:10px;"><?php echo $this->_var['spec']['name']; ?>：</strong>
...
?>
                ...
                <div class="center_btn">
                  ...
                  <div class="center_collect_btn"> <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)">收藏该商品</a> </div>
                   <?php echo $this->fetch('library/vip.lbi'); ?>
