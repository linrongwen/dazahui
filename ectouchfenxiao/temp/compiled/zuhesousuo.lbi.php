  ...
  <div class="searchRight_brand "> 
    ...
    <div class="screeBox clearfix"> <strong><?php echo $this->_var['lang']['brand']; ?>：</strong>
      <ul class="show_box" style=" height:60px; overflow:hidden; position:relative;">
        <?php $_from = $this->_var['brands']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'brand_0_69392300_1428407677');if (count($_from)):
    foreach ($_from AS $this->_var['brand_0_69392300_1428407677']):
?> 
        <?php if ($this->_var['brand_0_69392300_1428407677']['selected']): ?>
        <li><span><?php echo $this->_var['brand_0_69392300_1428407677']['brand_name']; ?></span></li>
        <?php else: ?>
        <li><a href="<?php echo $this->_var['brand_0_69392300_1428407677']['url']; ?>"><?php echo $this->_var['brand_0_69392300_1428407677']['brand_name']; ?></a></li>
        <?php endif; ?> 
    ...
    <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_69477800_1428407677');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_69477800_1428407677']):
?>
    <div class="screeBox clearfix"> <strong><?php echo htmlspecialchars($this->_var['filter_attr_0_69477800_1428407677']['filter_attr_name']); ?>：</strong>
      <ul class="show_box" style=" height:30px; overflow:hidden; position:relative;">
        <?php $_from = $this->_var['filter_attr_0_69477800_1428407677']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
