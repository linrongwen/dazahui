<div class="accountSideTop"> <a href="user.php" <?php if ($this->_var['action'] == 'default'): ?>class="curs"<?php endif; ?>> <?php echo $this->_var['lang']['label_welcome']; ?></a> </div>
...
<div class="blank"></div>
<a href="user.php?act=logout" ><img src="themes/miqinew/images/bnt_sign.gif"></a> 