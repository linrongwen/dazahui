...
E_D("replace into `wxch_keywords_article` values('2','11');");
E_D("replace into `wxch_keywords_article` values('3','4');");
E_D("replace into `wxch_keywords_article` values('3','10');");
E_D("replace into `wxch_keywords_article` values('4','11');");
E_D("replace into `wxch_keywords_article` values('5','4');");
E_D("replace into `wxch_keywords_article` values('5','10');");
E_D("replace into `wxch_keywords_article` values('6','11');");
E_D("replace into `wxch_keywords_article` values('7','4');");
E_D("replace into `wxch_keywords_article` values('7','10');");
E_D("replace into `wxch_keywords_article` values('8','4');");
E_D("replace into `wxch_keywords_article` values('8','10');");
E_D("replace into `wxch_keywords_article` values('8','12');");
