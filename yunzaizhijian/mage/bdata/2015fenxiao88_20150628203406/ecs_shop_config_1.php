...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','ECSHOP','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','ECSHOP演示站','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','ECSHOP演示站','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','ECSHOP演示站','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','','1');");
...
E_D("replace into `ecs_shop_config` values('304','3','thumb_width','text','','','100','1');");
E_D("replace into `ecs_shop_config` values('305','3','thumb_height','text','','','100','1');");
E_D("replace into `ecs_shop_config` values('306','3','image_width','text','','','230','1');");
E_D("replace into `ecs_shop_config` values('307','3','image_height','text','','','230','1');");
...
E_D("replace into `ecs_shop_config` values('604','6','template','hidden','','','default','1');");
E_D("replace into `ecs_shop_config` values('605','6','install_date','hidden','','','1418058091','1');");
...
E_D("replace into `ecs_shop_config` values('909','8','sms_signin','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('908','8','sms_ecmoban_password','password','','','','0');");
E_D("replace into `ecs_shop_config` values('907','8','sms_ecmoban_user','text','','','','0');");
E_D("replace into `ecs_shop_config` values('910','2','agent_search_response','text','','','您所查询的代理商{name}，是我公司{level}','1');");
