...
E_D("replace into `ecs_touch_shipping` values('8','fpd','运费到付','所购商品到达即付运费','0','1','1','','','','2','0');");
E_D("replace into `ecs_touch_shipping` values('9','cac','上门取货','买家自己到商家指定地点取货','0','1','1','','','','2','0');");
