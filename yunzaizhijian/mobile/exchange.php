        ...
        if (is_array($goodslist)) {
            foreach ($goodslist as $vo) {
               ...
               // $watermark_img = empty($vo['watermark_img']) ? '' : '<img width="55" height="16" src="' . 'themes/' . $_CFG['template'] . '/images/' . $vo['watermark_img'] . '.png" alt="' . $vo['goods_name'] . '" />';
                ...
                $sayList[] = array(
                    'pro-inner' => '
        <div class="proImg-wrap"> <a href="' . $vo['url'] . '&wxid='.$wxid.'" > <img src="' . $config['site_url'] . 'mobile/' . $vo['goods_thumb'] . '" alt="' . $vo['goods_name'] . '"> </a> </div>
        <div class="proInfo-wrap">
          <div class="proTitle"> <a href="' . $vo['url'] . '&wxid='.$wxid.'" >' . $name . '</a> </div>
