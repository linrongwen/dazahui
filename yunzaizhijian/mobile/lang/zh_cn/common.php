...
$_LANG['copyright'] = "&copy; 2013-%s %s 版权所有，并保留所有权利。";
...
$_LANG['cod'] = '配送决定';
$_LANG['payment_no_exist'] = '支付方式不存在';
...
$_LANG['p_y']['link_start'] = '<a href="http://www.ico甜心100微信商城.com" target="_blank" style=" font-family:Verdana; font-size:11px;">';
