...
$_LANG['cfg_name']['agent_search_response'] = '代理商查询回复模板';
...
$_LANG['cfg_name']['be_distri_user'] = '成为分销会员的消费额度';
$_LANG['cfg_name']['one_level_deduct'] = '一级会员提成';
$_LANG['cfg_name']['two_level_deduct'] = '二级会员提成';
$_LANG['cfg_name']['three_level_deduct'] = '三级会员提成';
...
$_LANG['cfg_name']['service_from_days'] = '退换货开始(发货后几天起)';
$_LANG['cfg_name']['service_end_days'] = '退换货结束(发货后几天止)';
...
$_LANG['cfg_desc']['one_level_deduct'] = '一级会员提成，单位为(%)，仅需要输入数值即可';
$_LANG['cfg_desc']['two_level_deduct'] = '二级会员提成，单位（%），仅输入数值即可';
$_LANG['cfg_desc']['three_level_deduct'] = '三级会员提成，单位（%），仅输入数值即可';
$_LANG['cfg_desc']['be_distri_user'] = '输入成为分销会员的消费价格，以元为单位，只需要输入数值';
$_LANG['cfg_desc']['service_end_days'] = '发货后第X-Y天可退换货，例如：上面输7，下面输30，就是发货后7-30天可退换货';
