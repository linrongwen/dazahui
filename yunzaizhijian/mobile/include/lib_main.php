...
function assign_template($ctype = '', $catlist = array())
{
	...
	$smarty->assign('cfg_qq',        $GLOBALS['_CFG']['qq']);
	$smarty->assign('cfg_qq',        $GLOBALS['_CFG']['qq']);
	...
	$smarty->assign('service_from_days', $GLOBALS['_CFG']['service_from_days']);
	$smarty->assign('service_end_days',  $GLOBALS['_CFG']['service_end_days']);
