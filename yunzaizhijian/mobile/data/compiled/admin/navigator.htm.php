...
<tr>
	<th><?php echo $this->_var['lang']['item_name']; ?></th><th>小图标</th><th><?php echo $this->_var['lang']['item_ifshow']; ?></th><th><?php echo $this->_var['lang']['item_opennew']; ?></th><th><?php echo $this->_var['lang']['item_vieworder']; ?></th><th><?php echo $this->_var['lang']['item_type']; ?></th><th width="60px"><?php echo $this->_var['lang']['handler']; ?></th>
</tr>
...
<tr>
	...
	<td align="center"><img src="<?php echo $this->_var['val']['pic']; ?>" width="48" height="48" /></td>
  <td align="center">
