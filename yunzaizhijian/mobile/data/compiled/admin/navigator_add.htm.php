...
<tr>
    <td><a href="javascript:showNotice('ico');" title="<?php echo $this->_var['lang']['notice_url']; ?>"><img src="images/notice.gif" width="16" height="16" border="0">小图标</a></td> <td><input type="text" name="item_pic" value="<?php echo $this->_var['rt']['item_pic']; ?>" size="40" /></td>
</tr>
  <tr>
    <td></td>
    <td>
<span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="ico">请上传ico图标到模板images目录下</span></td>
  </tr>
<tr>
...
<tr style="display:none">
  ...
  <option value='top' <?php echo $this->_var['rt']['item_type_top']; ?>><?php echo $this->_var['lang']['top']; ?></option><option value='middle' <?php echo $this->_var['rt']['item_type_middle']; ?> selected="selected"><?php echo $this->_var['lang']['middle']; ?></option><option value='bottom' <?php echo $this->_var['rt']['item_type_bottom']; ?>><?php echo $this->_var['lang']['bottom']; ?></option>
  </select></td>
</tr>
<tr align="center">
  <td colspan="2">
