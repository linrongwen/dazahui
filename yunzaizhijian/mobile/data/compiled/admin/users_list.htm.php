...
?>
  <tr>
    ...
    <td align="center"><img <?php if ($this->_var['user']['is_distributor']): ?>src="images/yes.gif"<?php else: ?><img src="images/no.gif"<?php endif; ?> onclick="listTable.toggle(this, 'edit_distributor', <?php echo $this->_var['user']['user_id']; ?>)" title="单击修改分销商身份" style="cursor:pointer"></td>
    <td align="center"><?php if ($this->_var['user']['is_subscribe']): ?> <img src="images/yes.gif"> <?php else: ?> <img src="images/no.gif"> <?php endif; ?></td>
    ...
    <td align="center">
      ...
      <a href="users.php?act=user_detail&id=<?php echo $this->_var['user']['user_id']; ?>" title="用户基本资料查看"><img src="images/user_detail.png" border="0" height="18" width="18" /></a>
      ...
      <a href="users.php?act=user_favourite&id=<?php echo $this->_var['user']['user_id']; ?>" title="收藏查看"><img src="images/favourite.jpg" border="0" height="16" width="18" /></a>
