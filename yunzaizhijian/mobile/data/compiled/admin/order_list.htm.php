...
<div class="form-div">
  <form action="javascript:searchOrder()" name="searchForm">
    ...
    <font color="red"><a href="javascript:;" onclick="order_to_excel()"><font color="red">批量导出excel</font></a></font>
  </form>
</div>
<script>
...
?>
  <tr>
    ...
    <td align="center" valign="top" nowrap="nowrap"><?php echo $this->_var['lang']['os'][$this->_var['order']['order_status']]; ?>,<?php echo $this->_var['lang']['ps'][$this->_var['order']['pay_status']]; ?>,<?php echo $this->_var['lang']['ss'][$this->_var['order']['shipping_status']]; ?>,<?php if ($this->_var['order']['distribute_status']): ?>已分销<?php else: ?>未分销<?php endif; ?></td>
    <td align="center" valign="top"  nowrap="nowrap">
     ...
     <?php endif; ?>
     <?php if ($this->_var['order']['pay_status'] == 2 && $this->_var['order']['distribute_status'] == 0): ?><br><a href="javascript:;" onclick="javascript:if(window.confirm('<?php echo $this->_var['lang']['js_languages']['distribute_confirm']; ?>')){location.href='order.php?id=<?php echo $this->_var['order']['order_id']; ?>&act=distribute_order';}">分销审核</a><?php endif; ?> <?php if ($this->_var['order']['distribute_status']): ?><br><a href="javascript:;" onclick="javascript:if(window.confirm('您确定要取消分销吗？')){location.href='order.php?id=<?php echo $this->_var['order']['order_id']; ?>&act=cancel_distribute';}">取消分销</a><?php endif; ?>
    </td>
  </tr>
