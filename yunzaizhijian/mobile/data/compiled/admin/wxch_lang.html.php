...
?>
    <tr>
    <td align="center"><span><?php echo $this->_var['list']['lang_name']; ?></span></td>
    <td align="center"><span><?php echo $this->_var['list']['lang_value']; ?></span></td>
    <td align="center" nowrap="true"><span>
      <a href="wxch_lang.php?act=edit&id=<?php echo $this->_var['list']['lang_id']; ?>" title="编辑"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>&nbsp;
     <!--  --></span>
    </td>
   </tr>
