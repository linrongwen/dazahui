        ...
        <?php echo $this->html_options(array('options'=>$this->_var['suppliers_list_name'],'selected'=>$this->_var['goods']['suppliers_id'])); ?>
         ...
         <?php endif; ?>
          <tr>
            ...
            <td><input type="text" name="shop_price" value="<?php echo $this->_var['goods']['shop_price']; ?>" size="20"/>
...
?>
          ...
          <tr>
            <td class="label">初始销量</td>
            <td><input type="number" name="init_sale_count" value="<?php echo empty($this->_var['goods']['init_sale_count']) ? '0' : $this->_var['goods']['init_sale_count']; ?>" size="8" />
            </td>
          </tr>
          <tr>
    ...
    <td><input type="text " name="one_level_deduct" size="20" value="<?php echo empty($this->_var['goods']['one_level_deduct']) ? '0' : $this->_var['goods']['one_level_deduct']; ?>"/> %<br />
          <span class="notice-span" style="display:block"  id="noticeshop_title">一级会员提成，单位为(%)，仅需要输入数值即可，0为不返佣</span>
</td>
  </tr>
   <tr>
    <td class="label">二级会员提成:</td>
    <td><input type="text " name="two_level_deduct" size="20" value="<?php echo empty($this->_var['goods']['two_level_deduct']) ? '0' : $this->_var['goods']['two_level_deduct']; ?>"/> %<br />
          <span class="notice-span" style="display:block"  id="noticeshop_title">二级会员提成，单位为(%)，仅需要输入数值即可，0为不返佣</span>
</td>
  </tr>
   <tr>
    <td class="label">三级会员提成:</td>
    <td><input type="text " name="three_level_deduct" size="20" value="<?php echo empty($this->_var['goods']['three_level_deduct']) ? '0' : $this->_var['goods']['three_level_deduct']; ?>"/> %<br />
        ...
        <table width="90%" id="detail-table" style="display:none">
          <tr>
            <td><textarea id="goods_desc" name="goods_desc" style="width:800px;height:400px;visibility:hidden;"><?php echo $this->_var['goods']['goods_desc']; ?></textarea>
<script src="../data/kindeditor/kindeditor-min.js" charset="utf-8"></script>
<script src="../data/kindeditor/lang/zh_CN.js" charset="utf-8"></script>
<script>
	var KE;
  KindEditor.ready(function(K) {
        KE = K.create("textarea[name='goods_desc']", {
            ...
            'italic', 'underline', 'strikethrough', 'lineheight', 'removeformat', '|', 'image', 'table', 'hr', 'emoticons', 'link', 'unlink', '|', 'about'],
						cssPath : "../data/kindeditor/themes/default/default.css",
...
<!--            <td><input type="text" name="goods_number" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="20" <?php if ($this->_var['code'] != '' || $this->_var['goods']['_attribute'] != ''): ?>readonly="readonly"<?php endif; ?> /><br />-->
          ...
          <tr>
            ...
            <td><input type="checkbox" name="is_best" value="1" <?php if ($this->_var['goods']['is_best']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_best']; ?> <input type="checkbox" name="is_new" value="1" <?php if ($this->_var['goods']['is_new']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_new']; ?> <input type="checkbox" name="is_hot" value="1" <?php if ($this->_var['goods']['is_hot']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_hot']; ?>  <input type="checkbox" name="is_join" value="1" <?php if ($this->_var['goods']['is_join']): ?>checked="checked"<?php endif; ?> />加盟</td>
          </tr>
          <tr id="alone_sale_1">
