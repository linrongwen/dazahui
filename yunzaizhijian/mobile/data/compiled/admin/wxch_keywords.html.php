...
<h1>
<span class="action-span"><a href="wxch_keywords.php?act=add&type=image">添加图文新规则</a></span>
<span class="action-span"><a href="wxch_keywords.php?act=add&type=text">添加文本新规则</a></span>
...
<table cellspacing='1' cellpadding='3' id='list-table'>
  <tr>
    <th><a href="javascript:listTable.sort('title'); ">规则名称</a></th>
    <th><a href="javascript:listTable.sort('cat_id'); ">关键词</a></th>
    <th><a href="javascript:listTable.sort('article_type'); ">消息类型</a></th>
    <th><a href="javascript:listTable.sort('is_open'); ">推送量</a></th>
    <th><a href="javascript:listTable.sort('add_time'); ">状态</a></th>
    <th>操作</th>
  </tr>
...
?>
    ...
    <td align="left"><span><?php echo $this->_var['list']['keyword']; ?></span></td>
    <td align="center"><span><?php echo $this->_var['list']['type_name']; ?></span></td>
    <td align="center"><?php echo $this->_var['list']['count']; ?></td>
    <td align="center"><span>
    <img src="images/<?php if ($this->_var['list']['status'] == 1): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_show', <?php echo $this->_var['list']['id']; ?>)" /></span></td>
    <td align="center" nowrap="true"><span>
      <a href="wxch_keywords.php?act=edit<?php if ($this->_var['list']['type'] == 1): ?>&type=text<?php else: ?>&type=image<?php endif; ?>&id=<?php echo $this->_var['list']['id']; ?>" title="编辑"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>&nbsp;
     <!--  --><a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['id']; ?>, '您确认要删除这个规则吗？')" title="移除"><img src="images/icon_drop.gif" border="0" height="16" width="16"></a><!--  --></span>
    </td>
   </tr>
