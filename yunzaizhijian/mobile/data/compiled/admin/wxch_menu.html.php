...
<!-- 通用信息 -->
<table width="80%" id="one-table" align="center">
    <tr>
    ...
    <tr>
        ...
        <td>
                <label><input type="text" name="first_value[]" value="<?php echo $this->_var['data']['first']['0']['value']; ?>" size="50"/></label>
        </td>
    </tr>
...
?>
    <tr>
        ...
        <td>
                <label><input type="text" name="value1[]" value="<?php echo $this->_var['items']['value']; ?>" size="50"/></label>
        </td>
    </tr>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
</table>
<table width="80%" id="two-table" align="center" style="display:none">
    <tr>
            <td class="label">级别&nbsp;&nbsp;</td>
            <td><strong>类型</strong></td>
            <td><strong>名称</strong></td>
    ...
    <tr>
        ...
        <td>
                <label><input type="text" name="first_value[]" value="<?php echo $this->_var['data']['first']['1']['value']; ?>" size="50"/></label>
        </td>
    </tr>
...
?>
    <tr>
        ...
        <td>
                <label><input type="text" name="value2[]" value="<?php echo $this->_var['items']['value']; ?>" size="50"/></label>
        </td>
    </tr>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    
</table>
<table width="80%" id="three-table" align="center" style="display:none">
    <tr>
            <td class="label">级别&nbsp;&nbsp;</td>
            <td><strong>类型</strong></td>
            <td><strong>名称</strong></td>
    ...
    <tr>
        ...
        <td>
                <label><input type="text" name="first_value[]" value="<?php echo $this->_var['data']['first']['2']['value']; ?>" size="50"/></label>
        </td>
    </tr>
...
?>
    <tr>
        ...
        <td>
                <label><input type="text" name="value3[]" value="<?php echo $this->_var['items']['value']; ?>" size="50"/></label>
        </td>
    </tr>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
</table>
