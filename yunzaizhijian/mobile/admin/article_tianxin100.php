...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('action_link',  array('text' => "添加推广单品页面", 'href' => 'article_tianxin100.php?act=add'));
    ...
    assign_query_info();
    $smarty->display('article_list_tianxin100.htm');
}
...
if ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->assign('cat_select',  article_cat_list(0));
    $smarty->assign('ur_here',     "添加推广单品");
    $smarty->assign('action_link', array('text' => "查看正在推广的单品", 'href' => 'article_tianxin100.php?act=list'));
    $smarty->assign('form_action', 'insert');

    assign_query_info();
    $smarty->display('article_info_tianxin100.htm');
}
...
if ($_REQUEST['act'] == 'insert')
{
    ...
    $link[1]['href'] = 'article_tianxin100.php?act=list';
