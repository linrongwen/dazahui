...
if ($_REQUEST['act'] == 'insert') {
	...
	$cat['one_level_deduct'] = intval($_POST['one_level_deduct']);
	$cat['two_level_deduct'] = intval($_POST['two_level_deduct']);
	$cat['three_level_deduct'] = intval($_POST['three_level_deduct']);
