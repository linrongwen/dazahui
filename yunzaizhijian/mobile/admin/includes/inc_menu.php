...
//分销设置
$modules['15_rec']['affiliate']                     = 'wxch-ent.php?act=wxconfig';
//$modules['15_rec']['affiliate_ck']                  = 'affiliate_ck.php?act=list';
$modules['15_rec']['danpin_tuiguang']                  ='article_tianxin100.php?act=list';
$modules['15_rec']['qr_set']                  ='qr_set.php?act=index';
$modules['15_rec']['distribute']                  ='distribute.php?act=list';
$modules['15_rec']['contribute']                  ='contribute.php?act=list';
...
//微信通管理
$modules['17_wechat']['wx_api']           = 'wxch-ent.php?act=wxconfig';
$modules['17_wechat']['wx_menu']        = 'wxch-ent.php?act=menu';
$modules['17_wechat']['wx_config']       = 'wxch-ent.php?act=config';
//$modules['17_wechat']['wx_autoreg']       = 'wxch-ent.php?act=autoreg';
...
//教程
$modules['19_shouce']['ectouch']        = 'help_wei.php?act=ectouch';
$modules['19_shouce']['weixintong']        = 'help_wei.php?act=weixintong';

//甜  心100新增 数据库管理菜单
$modules['18_backup']['02_db_manage']               = 'database.php?act=backup';
$modules['18_backup']['03_db_optimize']             = 'database.php?act=optimize';
$modules['18_backup']['04_sql_query']               = 'sql.php?act=main';
